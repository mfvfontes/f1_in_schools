...
<form role="form" id="reg_form" action="{$BASE_URL}actions/users/edit_profile.php" method="post">
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="Name"  value="{$userInfo.name}" required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <select name="country" id="country" class="form-control" required>
                        ...
                        {foreach from=$countries item=country}
                            <option value={$country.code} {if $userInfo.ccode == $country.code} selected {/if}> {$country.name} </option>
                        {/foreach}
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="dob"  class="form-control" placeholder="Select Date" value="{$userInfo.birthdate}" required />
                </div>

                <div class="checkboxGender">
                    <label for="Gender" class="control-label">
                        <label class="radio-inline">
                            <input type="radio" name="gender" value="M" {if $userInfo.gender == 'M'} checked {/if}> Male
                        </label>

                        <label class="radio-inline">
                            <input type="radio" name="gender" value="F" {if $userInfo.gender == 'F'} checked {/if}> Female
                        </label>
                    </label>
